...
// const NUM_NODES = 100;
const TEST_NAME = `batched-badger-testnet-csv`;
...
describe(`${TEST_NAME} - until the music stops`, () => {
  ...
  beforeAll(async () => {
    const { BatchedNetworkSimulator, Badger } = await import('../src/main.js');
