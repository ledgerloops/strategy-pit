import { ProbeMessage as ProbeMessage, TraceMessage as TraceMessage, MeetMessage, HaveProbesMessage, OkayToSendProbesMessage } from "./messages.js";
import { BasicMessageForwarder, HandRaisingStatus, Node } from "./node.js";
...
export class GiraffeProbeStore {
  private probes: {
    [id: string]: Probe
  } = {};
...
export class Giraffe extends Node {
  protected probeStore: GiraffeProbeStore = new GiraffeProbeStore();
